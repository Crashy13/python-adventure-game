...
def start_game():
    ...
    if "1" in choice:
        ...
        if "1" in choice:
            ...
            if '1' in choice:
                slowprint(
                    "Doesn't matter if you win by an inch or a mile, winning is winning. And you are a winner! Next question. Pick the object that is not like the others?\n 1. Car\n 2. Truck\n 3. Dandelion"
                )
                ...
                slowprint(
                    "Good job! Next question. Pick the object that is not like the others?\n 1. Car\n 2. Truck\n 3. Dandelion"
                )
                ...
                slowprint(
                    "You slammed into the car behind you. You fail."
                )
                game_over()
        ...
        if "1" in choice:
            ...
            if '2' in choice:
                ...
                slowprint(
                    "Come on, this is basic knowledge anyone should know."
                )
                game_over()
